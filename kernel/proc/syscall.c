...
static tty_t *
syscall_tty_from_fd(process_t *cur, uint32_t fd, uint32_t *tty_idx_out)
{
	file_handle_t *fh;
	tty_t *tty;
...
static int
syscall_write_console_bytes(process_t *cur, const char *buf, uint32_t len)
{
...
static int resolve_user_path(process_t *proc,
                             uint32_t user_ptr,
                             char *out,
                             uint32_t outsz);
static int resolve_user_path_at(process_t *proc,
                                uint32_t dirfd,
                                uint32_t user_ptr,
                                char *out,
                                uint32_t outsz);
...
static char *syscall_alloc_path_scratch(void)
{
...
static void
linux_copy_field(char *dst, uint32_t off, uint32_t len, const char *src)
{
	uint32_t i = 0;
...
static uint32_t SYSCALL_NOINLINE syscall_case_write(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_writev(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_readv(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_read(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sendfile64(uint32_t eax,
                                                         uint32_t ebx,
                                                         uint32_t ecx,
                                                         uint32_t edx,
                                                         uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_open(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_openat(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_close(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_access(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_faccessat(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fchmodat(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fchownat(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_futimesat(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_chmod(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_lchown_chown32(uint32_t eax,
                                                             uint32_t ebx,
                                                             uint32_t ecx,
                                                             uint32_t edx,
                                                             uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sync(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_umask(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_setsid(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getsid(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_readlink(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_readlinkat(uint32_t eax,
                                                         uint32_t ebx,
                                                         uint32_t ecx,
                                                         uint32_t edx,
                                                         uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getpriority(uint32_t eax,
                                                          uint32_t ebx,
                                                          uint32_t ecx,
                                                          uint32_t edx,
                                                          uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_setpriority(uint32_t eax,
                                                          uint32_t ebx,
                                                          uint32_t ecx,
                                                          uint32_t edx,
                                                          uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sysinfo(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_prlimit64(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_truncate64(uint32_t eax,
                                                         uint32_t ebx,
                                                         uint32_t ecx,
                                                         uint32_t edx,
                                                         uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_ftruncate64(uint32_t eax,
                                                          uint32_t ebx,
                                                          uint32_t ecx,
                                                          uint32_t edx,
                                                          uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sched_getaffinity(uint32_t eax,
                                                                uint32_t ebx,
                                                                uint32_t ecx,
                                                                uint32_t edx,
                                                                uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_utimensat(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_poll(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_ioctl(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fcntl64(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_execve(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_creat(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_unlink(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_unlinkat(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_clone(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fork_vfork(uint32_t eax,
                                                         uint32_t ebx,
                                                         uint32_t ecx,
                                                         uint32_t edx,
                                                         uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_clear(uint32_t eax,
                                                           uint32_t ebx,
                                                           uint32_t ecx,
                                                           uint32_t edx,
                                                           uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_scroll_up(uint32_t eax,
                                                               uint32_t ebx,
                                                               uint32_t ecx,
                                                               uint32_t edx,
                                                               uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_scroll_down(uint32_t eax,
                                                                 uint32_t ebx,
                                                                 uint32_t ecx,
                                                                 uint32_t edx,
                                                                 uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_yield(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_nanosleep(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_newselect(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_mkdir(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_mkdirat(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_rmdir(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_chdir(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getcwd(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_rename(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_renameat(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_linkat(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_symlinkat(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getdents(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_getdents_path(uint32_t eax,
                                                                   uint32_t ebx,
                                                                   uint32_t ecx,
                                                                   uint32_t edx,
                                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getdents64(uint32_t eax,
                                                         uint32_t ebx,
                                                         uint32_t ecx,
                                                         uint32_t edx,
                                                         uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_stat(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_stat64_lstat64(uint32_t eax,
                                                             uint32_t ebx,
                                                             uint32_t ecx,
                                                             uint32_t edx,
                                                             uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fstatat64(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fstat64(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_statx(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_statfs64(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_fstatfs64(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_clock_gettime(uint32_t eax,
                                                            uint32_t ebx,
                                                            uint32_t ecx,
                                                            uint32_t edx,
                                                            uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_clock_gettime64(uint32_t eax,
                                                              uint32_t ebx,
                                                              uint32_t ecx,
                                                              uint32_t edx,
                                                              uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_gettimeofday(uint32_t eax,
                                                           uint32_t ebx,
                                                           uint32_t ecx,
                                                           uint32_t edx,
                                                           uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_uname(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_set_thread_area(uint32_t eax,
                                                              uint32_t ebx,
                                                              uint32_t ecx,
                                                              uint32_t edx,
                                                              uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_set_tid_address(uint32_t eax,
                                                              uint32_t ebx,
                                                              uint32_t ecx,
                                                              uint32_t edx,
                                                              uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_modload(uint32_t eax,
                                                             uint32_t ebx,
                                                             uint32_t ecx,
                                                             uint32_t edx,
                                                             uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_exit_exit_group(uint32_t eax,
                                                              uint32_t ebx,
                                                              uint32_t ecx,
                                                              uint32_t edx,
                                                              uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_brk(uint32_t eax,
                                                  uint32_t ebx,
                                                  uint32_t ecx,
                                                  uint32_t edx,
                                                  uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_mmap(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_mmap2(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_munmap(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_mprotect(uint32_t eax,
                                                       uint32_t ebx,
                                                       uint32_t ecx,
                                                       uint32_t edx,
                                                       uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_pipe(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_pipe2(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
                                                    ...
                                                    uint32_t ebp)
{
	...
	if ((ecx & ~supported) != 0)
		return (uint32_t)-LINUX_EINVAL;
	rc = syscall_case_pipe(eax, ebx, ecx, edx, esi, edi, ebp);
	if (rc != 0)
		return rc;
	cur = sched_current();
...
static uint32_t SYSCALL_NOINLINE syscall_case_dup(uint32_t eax,
                                                  uint32_t ebx,
                                                  uint32_t ecx,
                                                  uint32_t edx,
                                                  uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_dup2(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_kill(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sigaction(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_rt_sigaction(uint32_t eax,
                                                           uint32_t ebx,
                                                           uint32_t ecx,
                                                           uint32_t edx,
                                                           uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sigreturn(uint32_t eax,
                                                        uint32_t ebx,
                                                        uint32_t ecx,
                                                        uint32_t edx,
                                                        uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_sigprocmask(uint32_t eax,
                                                          uint32_t ebx,
                                                          uint32_t ecx,
                                                          uint32_t edx,
                                                          uint32_t esi,
...
{
	{
		...
		if (ecx) {
			if (uaccess_copy_from_user(cur, &newmask, ecx, sizeof(newmask)) !=
			    0)
				return (uint32_t)-1;
		}
...
static uint32_t SYSCALL_NOINLINE syscall_case_rt_sigprocmask(uint32_t eax,
                                                             uint32_t ebx,
                                                             uint32_t ecx,
                                                             uint32_t edx,
                                                             uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_tcgetattr(uint32_t eax,
                                                               uint32_t ebx,
                                                               uint32_t ecx,
                                                               uint32_t edx,
                                                               uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_tcsetattr(uint32_t eax,
                                                               uint32_t ebx,
                                                               uint32_t ecx,
                                                               uint32_t edx,
                                                               uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_setpgid(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getpgid(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_lseek(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_llseek(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getpid(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_gettid(uint32_t eax,
                                                     uint32_t ebx,
                                                     uint32_t ecx,
                                                     uint32_t edx,
                                                     uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_getppid(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE
syscall_case_getuid32_getgid32_geteuid32_getegid32(uint32_t eax,
                                                   uint32_t ebx,
                                                   uint32_t ecx,
                                                   uint32_t edx,
                                                   uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_setuid32_setgid32(uint32_t eax,
                                                                uint32_t ebx,
                                                                uint32_t ecx,
                                                                uint32_t edx,
                                                                uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_waitpid(uint32_t eax,
                                                      uint32_t ebx,
                                                      uint32_t ecx,
                                                      uint32_t edx,
                                                      uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_wait4(uint32_t eax,
                                                    uint32_t ebx,
                                                    uint32_t ecx,
                                                    uint32_t edx,
                                                    uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_tcsetpgrp(uint32_t eax,
                                                               uint32_t ebx,
                                                               uint32_t ecx,
                                                               uint32_t edx,
                                                               uint32_t esi,
...
static uint32_t SYSCALL_NOINLINE syscall_case_drunix_tcgetpgrp(uint32_t eax,
                                                               uint32_t ebx,
                                                               uint32_t ecx,
                                                               uint32_t edx,
                                                               uint32_t esi,
                         ...
                         uint32_t ebp)
{
	...
	case SYS_SCHED_GETAFFINITY:
		return syscall_case_sched_getaffinity(
	...
	case SYS_DRUNIX_SCROLL_DOWN:
		return syscall_case_drunix_scroll_down(
		    eax, ebx, ecx, edx, esi, edi, ebp);
	...
	case SYS_DRUNIX_GETDENTS_PATH:
		return syscall_case_drunix_getdents_path(
		    eax, ebx, ecx, edx, esi, edi, ebp);
	...
	case SYS_SETUID32:
	case SYS_SETGID32:
		return syscall_case_setuid32_setgid32(
		    eax, ebx, ecx, edx, esi, edi, ebp);
