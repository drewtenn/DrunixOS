...
typedef struct {
	...
	uint32_t
	    inode_bitmap_lba; /* start LBA of the inode bitmap block           */
	uint32_t
	    block_bitmap_lba; /* start LBA of the block bitmap block           */
	uint32_t
	    inode_table_lba;   /* start LBA of the inode table                  */
...
typedef struct {
	...
	uint16_t
	    link_count; /* number of directory entries referencing this inode */
	uint32_t size;  /* file size in bytes (0 for directories)            */
	uint32_t
	    block_count;     /* number of data blocks allocated                   */
	...
	uint32_t
	    double_indirect; /* double-indirect block LBA (0 = none)              */
