...
static int vfs_mutation_lookup_ctx_init(vfs_lookup_ctx_t *ctx, const char *path)
{
...
static int vfs_mount_child_name(const char *dir_path,
                                const vfs_mount_t *mnt,
                                const char **name_out,
