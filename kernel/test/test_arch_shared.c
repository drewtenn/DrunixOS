...
#define TEST_USER_HEAP_BRK (TEST_USER_IMAGE_START + 0x00018000u)
#define TEST_USER_GENERIC_START (USER_MMAP_MIN + 0x00010000u)
#define TEST_USER_SYSCALL_PAGE (USER_MMAP_MIN + 0x00080000u)
...
static void test_shared_dup2_bumps_pty_slave_ref(ktest_case_t *tc)
{
	static process_t proc;
	process_t *cur = shared_start_syscall_process(&proc);
	int idx;
