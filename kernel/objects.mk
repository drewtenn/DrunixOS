KOBJS = kernel/arch/x86/boot/kernel-entry.o kernel/arch/x86/start_kernel.o \
        ...
        kernel/drivers/blkdev.o kernel/drivers/blkdev_part.o kernel/blk/bcache.o kernel/drivers/chardev.o kernel/drivers/tty.o kernel/drivers/fbdev.o kernel/drivers/inputdev.o kernel/drivers/netdev.o kernel/drivers/wmdev.o shared/kbdmap.o \
