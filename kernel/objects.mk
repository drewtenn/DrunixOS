KOBJS = kernel/arch/x86/boot/kernel-entry.o kernel/arch/x86/start_kernel.o \
        ...
        kernel/gui/display.o kernel/gui/framebuffer.o kernel/arch/x86/boot/framebuffer_multiboot.o kernel/gui/font8x16.o kernel/gui/desktop.o kernel/gui/desktop_apps.o kernel/gui/terminal.o \
