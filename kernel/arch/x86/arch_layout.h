...
#define ARCH_KERNEL_DIRECT_MAP_END ((uintptr_t)0x08000000u)
#define ARCH_USER_VADDR_MIN ARCH_KERNEL_DIRECT_MAP_END
#define ARCH_USER_VADDR_MAX ((uintptr_t)0xC0000000u)
#define ARCH_USER_IMAGE_BASE ARCH_USER_VADDR_MIN
