...
#define MOUSE_EFFECTIVE_FRAMEBUFFER_PIXEL_SCALE                                \
	MOUSE_FRAMEBUFFER_PIXEL_SCALE_MIN
#elif MOUSE_FRAMEBUFFER_PIXEL_SCALE > MOUSE_FRAMEBUFFER_PIXEL_SCALE_MAX
#define MOUSE_EFFECTIVE_FRAMEBUFFER_PIXEL_SCALE                                \
	MOUSE_FRAMEBUFFER_PIXEL_SCALE_MAX
#else
...
int mouse_decode_packet(const mouse_packet_t *packet,
...
static void mouse_update_pointer(desktop_state_t *desktop,
                                 desktop_pointer_event_t *ev)
{
