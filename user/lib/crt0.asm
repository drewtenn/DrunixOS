...
;
; crt0 pops all three, stores envp in the libc global `environ`, pushes them
; in cdecl order, calls main(argc, argv, envp), then feeds the return value to
; sys_exit().  Programs with a two-argument main simply ignore the third stack
; argument under cdecl.
