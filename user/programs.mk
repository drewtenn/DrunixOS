PROGS = chello shell bbcompat dufstest redirtest ext3wtest threadtest tcccompat nanocompat hello writer reader sleeper date which cat echo wc grep head tail tee sleep env printenv basename dirname cmp yes sort uniq cut kill crash dmesg cpphello lsblk
