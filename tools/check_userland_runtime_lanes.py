...
def main():
    ...
    required_rexc_progs = {"hello", "echo", "printenv", "cat", "yes", "basename", "dirname", "sleep", "cmp", "which", "head", "wc", "writer", "reader", "sleeper", "date", "grep", "tee", "dmesg", "tail", "kill", "cpphello", "uniq", "sort", "cut", "env", "crash"}
