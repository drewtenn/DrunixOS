...
X86_PMM_KTESTS = (
    ...
    "test_multiboot_512m_map_sets_runtime_capacity",
    "test_multiboot_1g_map_sets_runtime_capacity",
    "test_multiboot_mmap_snapshot_survives_metadata_overlap",
)
...
X86_PROCESS_KTESTS = (
    ...
    "test_elf_loader_accepts_linux_style_pt_load",
    "test_elf_loader_rejects_below_user_min_pt_load",
    ...
    "test_vma_table_grows_beyond_legacy_limit",
    "test_vma_file_metadata_survives_address_space_copy",
    "test_proc_resource_clone_for_fork_copies_vma_storage",
    "test_proc_resource_defaults_and_fork_copy_commit_limits",
    "test_vma_unmap_range_splits_generic_mapping",
    "test_vma_unmap_range_advances_file_offset_for_right_split",
    "test_vma_unmap_range_rejects_heap_or_stack",
    "test_vma_protect_range_splits_and_requires_full_coverage",
    "test_vma_protect_range_preserves_file_backing_and_offsets",
    ...
    "test_mem_forensics_reports_committed_bytes",
    "test_mem_forensics_maps_use_linux_like_labels",
    "test_mem_forensics_maps_keeps_label_when_merging_file_vmas",
    ...
    "test_brk_obeys_data_limit_and_commit_accounting",
    "test_private_writable_anonymous_mmap_commit_release",
    "test_commit_reserve_counts_existing_reservations",
    "test_mprotect_read_to_write_reserves_commit_before_munmap",
    "test_mprotect_write_to_read_releases_commit_before_munmap",
    ...
    "test_linux_private_file_mmap_reserves_without_mapping",
...
X86_UACCESS_KTESTS = (
    ...
    "test_uaccess_faults_in_lazy_private_file_pages",
...
X86_ARCH_KTESTS = (
    ...
    "test_user_mapping_accepts_low_user_addresses",
    "test_paging_accepts_low_user_page_mapping",
            ...
            "arm64": (
                SourceMarkers(
                    ...
                    (
                        ...
                        "test_arm64_fdt_validates_snapshot_magic",
                        "test_arm64_fdt_rejects_garbage_blob",
                        "test_arm64_fdt_finds_memory_range",
                        "test_arm64_fdt_chosen_bootargs_optional",
