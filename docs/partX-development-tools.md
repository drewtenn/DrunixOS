...
The debugging workflow and C++ runtime support described in these chapters are written to apply to both architectures; GDB remote debugging and the C++ ABI requirements are the same whether the target is an x86 or an arm64 machine.
